#!/usr/bin/env python3
"""
Build a static HTML site for the Credit Knowledge Graph.
Usage: python3 build_credit.py
"""
...
VAULT = Path("/Users/harden/Documents/Obsidian Vault/信贷业务体系/信贷业务体系")
OUT = Path("/Users/harden/workspace/credit-knowledge-graph/credit-site")
SITE_TITLE = "信贷业务体系知识库"
SITE_LOGO = "C"
BASE_PATH = "/credit-knowledge-graph"  # GitHub Pages subdirectory
...
# --green:       primary accent (dark green)
# --green-dark:  darker green for hover
# --green-glow:  subtle green glow
...
<aside class="sidebar">
  <div class="sidebar-header"><a href="{BASE_PATH}/index.html" class="logo">信贷业务体系知识库</a></div>
...
<section class="hero-section">
  <div class="hero-eyebrow">Credit & Lending Business System</div>
  <h1 class="hero-title">信贷业务体系<span class="orange">知识库</span></h1>
  <p class="hero-sub"><b>{len(concept_files)} 个</b>核心概念，<b>{len(product_files)} 个</b>信贷产品，<b>{len(company_files)} 家</b>公司档案<br>
  从信用评估到智能风控——构建信贷行业的全景知识图谱</p>
</section>
...
<div class="nav-cards">
  <a href="{BASE_PATH}/index-pages/核心概念索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(concept_files)} 个信贷核心概念</div>
  ...
  <a href="{BASE_PATH}/index-pages/产品索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(product_files)} 个信贷产品</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
  <a href="{BASE_PATH}/index-pages/公司索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(company_files)} 家信贷公司</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
...
<div class="footer-promo">
  <div class="promo-story">
    <h3>关于本站</h3>
    <p>把信贷行业的核心概念、贷款产品、公司档案、关键人物整理成一张可以漫游的知识图谱。从信用评估到风控模型，从消费金融到供应链金融，覆盖信贷业务的全景视图。</p>
    <p>独有视角：<strong>概念交叉引用</strong>（每个概念都链接到相关产品和公司）和 <strong>风控模型分析</strong>——帮助你建立信贷行业的系统性认知。</p>
...
def main():
    ...
    assets_src = Path(__file__).parent / "assets-credit"
