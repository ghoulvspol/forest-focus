#!/usr/bin/env python3
"""
Build a static HTML site for the Bank Knowledge Graph.
Usage: python3 build_bank.py
"""
...
VAULT = Path("/Users/harden/Documents/Obsidian Vault/银行业务体系/银行业务体系")
OUT = Path("/Users/harden/workspace/bank-knowledge-graph/bank-site")
SITE_TITLE = "银行业务体系知识库"
SITE_LOGO = "B"
BASE_PATH = "/bank-knowledge-graph"  # GitHub Pages subdirectory
...
<aside class="sidebar">
  <div class="sidebar-header"><a href="{BASE_PATH}/index.html" class="logo">银行业务体系知识库</a></div>
...
<section class="hero-section">
  <div class="hero-eyebrow">Banking Business System</div>
  <h1 class="hero-title">银行业务体系<span class="orange">知识库</span></h1>
  <p class="hero-sub"><b>{len(concept_files)} 个</b>核心概念，<b>{len(product_files)} 个</b>银行产品，<b>{len(company_files)} 家</b>机构档案<br>
  从存款贷款到资本管理——构建银行业的全景知识图谱</p>
</section>
...
<div class="nav-cards">
  <a href="{BASE_PATH}/index-pages/核心概念索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(concept_files)} 个银行核心概念</div>
  ...
  <a href="{BASE_PATH}/index-pages/产品索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(product_files)} 个银行产品</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
  <a href="{BASE_PATH}/index-pages/公司索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(company_files)} 家银行机构</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
...
<div class="footer-promo">
  <div class="promo-story">
    <h3>关于本站</h3>
    <p>把银行业的核心概念、银行产品、机构档案、关键人物整理成一张可以漫游的知识图谱。从存款贷款到资本管理，从风险管理到金融科技，覆盖银行业务的全景视图。</p>
    <p>独有视角：<strong>概念交叉引用</strong>（每个概念都链接到相关产品和公司）和 <strong>风险管理框架</strong>——帮助你建立银行业的系统性认知。</p>
...
def main():
    ...
    assets_src = Path(__file__).parent / "assets-bank"
