#!/usr/bin/env python3
"""
Build a static HTML site for the Securities Knowledge Graph.
Usage: python3 build_securities.py
"""
...
VAULT = Path("/Users/harden/Documents/Obsidian Vault/证券业务体系/证券业务体系")
OUT = Path("/Users/harden/workspace/securities-knowledge-graph/securities-site")
SITE_TITLE = "证券业务体系知识库"
SITE_LOGO = "S"
BASE_PATH = "/securities-knowledge-graph"  # GitHub Pages subdirectory
...
# --gold:        primary accent (deep gold)
# --gold-dark:   darker gold for hover
# --gold-glow:   subtle gold glow
# --dark:        deep dark for sidebar
# --dark-light:  lighter dark for sidebar elements
...
<aside class="sidebar">
  <div class="sidebar-header"><a href="{BASE_PATH}/index.html" class="logo">证券业务体系知识库</a></div>
...
<section class="hero-section">
  <div class="hero-eyebrow">Securities Business System</div>
  <h1 class="hero-title">证券业务体系<span class="orange">知识库</span></h1>
  <p class="hero-sub"><b>{len(concept_files)} 个</b>核心概念，<b>{len(product_files)} 个</b>证券产品，<b>{len(company_files)} 家</b>机构档案<br>
  从股票债券到衍生品——构建证券行业的全景知识图谱</p>
</section>
...
<div class="nav-cards">
  <a href="{BASE_PATH}/index-pages/核心概念索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(concept_files)} 个证券核心概念</div>
  ...
  <a href="{BASE_PATH}/index-pages/产品索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(product_files)} 个证券产品</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
  <a href="{BASE_PATH}/index-pages/公司索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(company_files)} 家证券机构</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
...
<div class="footer-promo">
  <div class="promo-story">
    <h3>关于本站</h3>
    <p>把证券业的核心概念、证券产品、机构档案、关键人物整理成一张可以漫游的知识图谱。从股票债券到衍生品，从交易机制到监管框架，覆盖证券业务的全景视图。</p>
    <p>独有视角：<strong>概念交叉引用</strong>（每个概念都链接到相关产品和公司）和 <strong>投资策略分析</strong>——帮助你建立证券业的系统性认知。</p>
...
def main():
    ...
    assets_src = Path(__file__).parent / "assets-securities"
