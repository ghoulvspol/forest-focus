#!/usr/bin/env python3
"""
Build a static HTML site for the Payment Knowledge Graph.
Usage: python3 build_pay.py
"""
...
VAULT = Path("/Users/harden/Documents/Obsidian Vault/支付业务体系/支付业务体系")
OUT = Path("/Users/harden/workspace/payment-knowledge-graph/pay-site")
SITE_TITLE = "支付业务体系知识库"
SITE_LOGO = "P"
BASE_PATH = "/payment-knowledge-graph"  # GitHub Pages subdirectory, set to "" for root domain
...
# --orange:      primary accent (vibrant orange)
# --orange-dark: darker orange for hover
# --orange-glow: subtle orange glow
# --dark:        warm dark for sidebar
...
<aside class="sidebar">
  <div class="sidebar-header"><a href="{BASE_PATH}/index.html" class="logo">支付业务体系知识库</a></div>
...
<section class="hero-section">
  <div class="hero-eyebrow">Payment Business System</div>
  <h1 class="hero-title">支付业务体系<span class="orange">知识库</span></h1>
  <p class="hero-sub"><b>{len(concept_files)} 个</b>核心概念，<b>{len(product_files)} 个</b>产品模型，<b>{len(company_files)} 家</b>公司档案<br>
  从四方模式到嵌入式支付——构建支付行业的全景知识图谱</p>
</section>
...
<div class="nav-cards">
  <a href="{BASE_PATH}/index-pages/核心概念索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(concept_files)} 个支付核心概念</div>
  ...
  <a href="{BASE_PATH}/index-pages/产品索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(product_files)} 个支付产品</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
  <a href="{BASE_PATH}/index-pages/公司索引.html" class="nav-card">
    ...
    <div class="nav-card-sub">{len(company_files)} 家支付公司</div>
    <span class="nav-card-arrow">{arrow}</span>
  </a>
...
<div class="footer-promo">
  <div class="promo-story">
    <h3>关于本站</h3>
    <p>把支付行业的核心概念、产品模型、公司档案、关键人物整理成一张可以漫游的知识图谱。从四方模式到嵌入式支付，从聚合收单到跨境清结算，覆盖支付业务的全景视图。</p>
    <p>独有视角：<strong>概念交叉引用</strong>（每个概念都链接到相关产品和公司）和 <strong>产品架构分析</strong>——帮助你建立支付行业的系统性认知。</p>
    <p class="promo-credit">本站是由作者与 <strong>Claude Code</strong> 共同完成的。</p>
  </div>
  <div class="promo-qr">
    <img src="{BASE_PATH}/assets/qrcode.jpg" alt="公众号二维码" class="qr-img">
...
def main():
    ...
    assets_src = Path(__file__).parent / "assets-pay"
